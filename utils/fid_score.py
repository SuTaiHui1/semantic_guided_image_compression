...
def get_activations(
    ...
    # ====================== 修复点1：添加正确的图像预处理 ======================
    # InceptionV3 强制要求：Resize到299x299 + 归一化到[-1,1]
    transforms = TF.Compose([
        TF.Resize((299, 299)),  # 必须缩放到299x299
        TF.ToTensor(),
        TF.Normalize(mean=[0.5, 0.5, 0.5], std=[0.5, 0.5, 0.5])  # 像素值 [0,1] → [-1, 1]
    ])
    # ========================================================================
...
def calculate_activation_statistics(
    ...
    Returns:
    -- mu    : The mean over samples of activations of the pool_3 layer of
               the inception model.
